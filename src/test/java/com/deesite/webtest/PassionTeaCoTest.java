package com.deesite.webtest;
import com.deesite.pageobjects.PassionTeaCoWelcomePO.WELCOME_PAGE_IMG;
import com.deesite.pageobjects.PassionTeaCoWelcomePO.MENU_LINKS;
import com.deesite.global.Global_VARS;
import com.deesite.managers.CreateDriver;
import com.deesite.pageobjects.PassionTeaCoWelcomePO;
import com.deesite.utils.JSONDataProvider;
...
public class PassionTeaCoTest {
    ...
    private static final String DATA_FILE = "/Users/deepakarora/git/SeleniumFrameworkDesign/src/test/java/com/deesite/webtest/PassionTeaCo.json";
    ...
    public void tc001_passionTeaCo(String rowID, String description, JSONObject testData)
            throws Exception {
     ...
     */
    @Test(groups = {"PASSION_TEA"}, dataProvider = "fetchData_JSON", dataProviderClass = JSONDataProvider.class, enabled = true)
    public void tc004_passionTeaCo(String rowID, String description,
                                   JSONObject testData)
            throws Exception {
        // verify headings
     ...
     */
    @Test(groups = {"PASSION_TEA"}, dataProvider = "fetchData_JSON", dataProviderClass = JSONDataProvider.class, enabled = true)
    public void tc005_passionTeaCo(String rowID, String description,
                                   JSONObject testData)
            throws Exception {
    // verify paragraphs
     ...
     */
    @Test(groups = {"PASSION_TEA"}, dataProvider = "fetchData_JSON", dataProviderClass = JSONDataProvider.class, enabled = true)
    public void tc006_passionTeaCo(String rowID, String description,
                                   JSONObject testData)
            throws Exception {
        // verify menu links
        welcome.navigateMenuLink(MENU_LINKS.valueOf(
        testData.get("element").toString()),testData.get("title").toString());
    }
}